...
import { ArrowRight, Mail, Lock, LogIn, Github, Chrome } from "lucide-react";
    ...
    <div className="min-h-screen bg-black pt-32 pb-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-md mx-auto relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl font-normal text-white mb-3 tracking-tight">Welcome back</h1>
          ...
          <form onSubmit={async (e) => {
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="block text-sm text-zinc-400 font-normal">Password</label>
